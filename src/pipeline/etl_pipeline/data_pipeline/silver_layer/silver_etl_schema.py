...
silver_dim_user_demographic_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
...
silver_dim_user_contact_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
...
silver_dim_user_region_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
...
silver_dim_asset_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
...
silver_dim_user_income_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
        StructField("amt_income_total", DoubleType()),
...
silver_dim_external_source_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
...
silver_dim_provided_docs_schema = StructType(
    [
        StructField("sk_id_curr", LongType()),
...
silver_dim_aggregated_schema = StructType([
    StructField("sk_id_curr", LongType()),
...
silver_dim_bureau_schema = StructType([
    StructField("sk_id_curr", StringType()),
...
silver_fact_bureau_balance_schema = StructType(
    [
