...
if __name__ == "__main__":
    ...
    pipeline_args = {
        ...
        "raw_train_object":     "data/data/application_train.csv",
        "raw_test_object":      "data/data/application_test.csv",
        "dest_train_object":    "data/data/train/preprocessed_train_v2.csv",
        "dest_test_object":     "data/data/test/preprocessed_test_v2.csv",
        "n_features_to_select": "auto",
        "data_version":         "v2",
        "model_name":           "xgb",
        "version":              "v2",
        "experiment_name":      "testjoblib",
    }
