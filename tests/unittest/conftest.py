...
def patch_api_joblib():
    ...
    main.model = joblib.load(base_dir / "model.joblib")
    main.transformer = joblib.load(base_dir / "transformer.joblib")
...
def exclude_opentelemetry_imports():
    ...
    fake_sdk_metrics = types.SimpleNamespace(MeterProvider=lambda *a, **k: None)
